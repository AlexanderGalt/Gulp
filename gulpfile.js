...
// yarn install - установука gulp в новый проект.
// yarn run dev - сборка в режиме разрабочика (без: группировки медиа запросов css, автопрефиксора css,сжатия css, сжатия и конвертирования изображений, добавления версий файлов).
// ctrl + c - выход из режима разработчика.
// yarn run prod - сборка в режиме продакшана (без наблюдателя и запуская сервера).
// yarn run svgSprive - создать SVGспрайта.
// yarn run zip - создать архив продакшана.
// yarn run deploy - выгрузка продакшана по фтп.
// rm -rf node_modules - удаляет node_modules
